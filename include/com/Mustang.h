...
namespace plug::com
{
    ...
    public:
        ...
        MemoryBank start_amp(char list[][32] = nullptr, amp_settings* amp_set = nullptr, fx_pedal_settings* effects_set = nullptr);
        void stop_amp();
    ...
    private:
        ...
        MemoryBank decode_data(const std::array<Packet, 7>& data, amp_settings* amp_set, fx_pedal_settings* effects_set);
        MemoryBank loadInitialData(char list[][32], amp_settings* amp_set, fx_pedal_settings* effects_set);
